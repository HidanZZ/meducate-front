...
const CardMedicine = ({ medicament }: { medicament: Medicament | null }) => {
  ...
  if (!imageName) {
    if (forme.includes('SOLUTION INJECTABLE')) {
      imageName = 'needle.jpg'; // Image for Solution Injectable
