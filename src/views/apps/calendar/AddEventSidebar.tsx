...
const defaultState: DefaultStateType = {
  ...
  title: 'Random Event',
  guests: ['John Doe', 'Jane Smith', 'Alice', 'Bob'],
  allDay: true,
  description: 'This is a random event description.',
  endDate: new Date(),
          ...
          <form onSubmit={handleSubmit(onSubmit)} autoComplete='off'>
            ...
            <FormControl fullWidth sx={{ mb: 6 }}>
              ...
              <Select
                ...
                readOnly
              >
                <MenuItem value='Medical Events'>Medical Events</MenuItem>
                <MenuItem value='Personal'>Personal</MenuItem>
                <MenuItem value='Business'>Business</MenuItem>
                <MenuItem value='Social Events'>Social Events</MenuItem>
                <MenuItem value='Holiday'>Holiday</MenuItem>
                <MenuItem value='Product Release'>Product Release</MenuItem>
